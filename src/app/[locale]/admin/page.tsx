        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div className="space-y-2">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] font-black text-teal-500 uppercase tracking-[0.3em]">Command.Center</span>
            </div>
            <h2 className="text-5xl font-black tracking-tighter text-white uppercase italic leading-none">
              Control <span className="text-teal-500">Node</span>
            </h2>
          ...
          <div className="flex items-center gap-4 bg-white/5 border border-white/10 p-4 rounded-none">
            <div className="flex flex-col items-end">
              <span className="text-[9px] font-black text-slate-500 uppercase tracking-widest">System Time</span>
              ...
              <div className="cyber-card p-6 group relative overflow-hidden">
                ...
                <div className="flex flex-col gap-1 relative z-10">
                  ...
                  <div className="flex items-center gap-2 mt-2">
                    <span className="text-[9px] font-mono text-slate-600 uppercase tracking-widest">{stat.description}</span>
                    {stat.trend && (
                      <div className="flex items-center gap-1 text-[9px] font-black text-emerald-400 bg-emerald-500/5 px-2 py-0.5 border border-emerald-500/10">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          <div className="cyber-card p-8">
            <div className="flex items-center gap-6">
              ...
              <div className="flex-1">
                <p className="text-[10px] font-black text-slate-500 uppercase tracking-widest">Pending Verification</p>
            ...
            <div className="mt-6 pt-6 border-t border-white/5">
              <div className="flex justify-between items-center mb-2">
                <span className="text-[10px] font-black text-slate-600 uppercase">Queue.Priority</span>
                <span className="text-[10px] font-black text-orange-500 uppercase">CRITICAL</span>
              </div>
          ...
          <div className="cyber-card p-8">
            <div className="flex items-center gap-6">
              ...
              <div className="flex-1">
                <p className="text-[10px] font-black text-slate-500 uppercase tracking-widest">Total Node Output</p>
            ...
            <div className="mt-6 pt-6 border-t border-white/5 flex items-center justify-between">
              <div className="flex flex-col">
                <span className="text-[9px] font-black text-slate-600 uppercase">System Sync</span>
                <span className="text-[10px] font-black text-teal-400">100% ONLINE</span>
              </div>
          ...
          <div className="cyber-card p-8 relative overflow-hidden">
            ...
            <div className="flex items-center gap-6">
              ...
              <div className="flex-1">
                <p className="text-[10px] font-black text-slate-500 uppercase tracking-widest">Conversion Efficiency</p>
                <p className="text-4xl font-black text-white tabular-nums tracking-tighter italic">{conversionRate}%</p>
              </div>
            </div>
            <div className="mt-6 pt-6 border-t border-white/5">
              <div className="flex justify-between items-center mb-3">
                <span className="text-[10px] font-black text-slate-600 uppercase italic">Signal Lock</span>
                <span className="text-[10px] font-black text-emerald-400 tabular-nums">{conversionRate}%</span>
              </div>
            ...
            >
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-[10px] font-black text-white uppercase tracking-widest leading-none mb-1 italic">{action.title}</p>
                  <p className="text-[9px] text-slate-500 font-mono uppercase tracking-tighter">{action.description}</p>
                </div>
        ...
        <div className="grid gap-8 lg:grid-cols-2">
          ...
          <div className="space-y-6">
            <div className="flex items-center justify-between border-b border-white/5 pb-4">
              ...
              <button 
                className="text-[10px] font-black uppercase text-slate-500 hover:text-orange-500 transition-colors tracking-widest"
            ...
            <div className="space-y-3">
              {topAffiliates.length > 0 ? (
                topAffiliates.map((affiliate: any, index: number) => (
                  ...
                  >
                    <div className="flex h-10 w-10 shrink-0 items-center justify-center bg-black/60 border border-white/5 text-[10px] font-black text-slate-600 group-hover:text-orange-500 group-hover:border-orange-500/30 transition-all italic">
                      #{index + 1}
                    </div>
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-[9px] text-orange-500/60 font-mono tracking-tighter uppercase">ID.{affiliate.referralCode}</p>
                    </div>
                    <div className="text-right shrink-0">
                      <p className="text-sm font-black text-white tabular-nums italic">R{(affiliate.totalRevenue / 1).toLocaleString()}</p>
                      <p className="text-[9px] text-slate-600 font-black uppercase tracking-tighter">{affiliate.totalReferrals} UNITS</p>
                    </div>
                  </div>
                ))
              ) : (
                <div className="py-20 text-center opacity-20">
                  ...
                  <p className="text-[10px] font-black uppercase tracking-widest">Network Nodes Offline</p>
                </div>
              )}
            </div>
          </div>
          ...
          <div className="space-y-6">
            <div className="flex items-center justify-between border-b border-white/5 pb-4">
              ...
              <button 
                className="text-[10px] font-black uppercase text-slate-500 hover:text-teal-400 transition-colors tracking-widest"
                onClick={() => router.push('/admin/customers')}
              >
                Full Archive
              </button>
            ...
            <div className="space-y-3">
              {recentCustomers.length > 0 ? (
                recentCustomers.slice(0, 5).map((customer) => (
                  ...
                  >
                    <div className="text-[9px] font-black text-slate-600 w-12 shrink-0 text-center uppercase tracking-tighter leading-none border-r border-white/5 pr-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-[9px] text-slate-600 font-mono uppercase tracking-widest italic">NODE: {customer.affiliateName}</p>
                    </div>
                ...
                <div className="py-20 text-center opacity-20">
                  ...
                  <p className="text-[10px] font-black uppercase tracking-widest">Signal Stream Silent</p>
                </div>
              )}
            </div>
          </div>
