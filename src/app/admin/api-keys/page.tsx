                  ...
                  <>
                    ...
                    <div className="space-y-4 py-4">
                      ...
                      <div className="grid gap-2">
                        ...
                        <p className="text-[15px] text-muted-foreground">Select one or more permission scopes</p>
                      </div>
                    </div>
                    <DialogFooter>
                ...
                {keys.map((key) => {
                  ...
                  return (
                    <TableRow key={key.id} className={isExpired ? 'opacity-60' : ''}>
                      ...
                      <TableCell>
                        <code className="rounded bg-muted px-2 py-1 text-[15px]">{key.maskedKey}</code>
                      </TableCell>
                      <TableCell>
                        <div className="flex gap-1">
                          {(key.scopes as string[]).map((s) => (
                            <Badge key={s} variant="secondary" className="text-[15px] capitalize">{s}</Badge>
                          ))}
                        </div>
                      </TableCell>
      ...
      <Card>
        ...
        <CardContent>
          <p className="text-sm text-muted-foreground mb-3">
            Include your API key in the <code className="rounded bg-muted px-1.5 py-0.5 text-[15px]">x-api-key</code> header:
          </p>
