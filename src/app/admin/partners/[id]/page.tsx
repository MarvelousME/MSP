...
export default function PartnerDetailPage() {
  ...
  const getStatusBadge = (status: string) => {
    ...
    const { variant, icon } = map[status] || { variant: 'outline' as const, icon: Clock };
    const Icon = icon as React.ComponentType<any>;
    return (
      <Badge variant={variant} className="gap-1 text-[15px]">
        ...
        left={
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <h2 className="text-2xl sm:text-3xl font-bold tracking-tight text-white">{partner.name}</h2>
                <p className="text-sm text-muted-foreground">{partner.email}</p>
                <div className="mt-1.5 flex flex-wrap items-center gap-2">
                  <Badge variant="outline" className="font-mono text-[15px] gap-1">
          ...
          <CardContent className="p-5">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[15px] text-muted-foreground">Customers</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-5">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[15px] text-muted-foreground">Pending</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-5">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[15px] text-muted-foreground">Paid Out</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-5">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[15px] text-muted-foreground">Payouts</p>
              </div>
            </div>
          </CardContent>
        </Card>
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-3 gap-4">
                  <div className="text-center">
                    ...
                    <p className="text-[15px] text-muted-foreground">Clicks</p>
                  </div>
                  <div className="text-center">
                    <div className="flex h-10 w-10 mx-auto items-center justify-center rounded-lg bg-muted">
                    ...
                    <p className="text-[15px] text-muted-foreground">Leads</p>
                  </div>
                  <div className="text-center">
                    <div className="flex h-10 w-10 mx-auto items-center justify-center rounded-lg bg-muted">
                    ...
                    <p className="text-[15px] text-muted-foreground">Revenue</p>
                  </div>
                </div>
                <Separator />
                <div className="space-y-3">
