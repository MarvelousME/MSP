...
export default function CustomerDetailPage() {
  ...
  const cfg = statusConfig[referral.status as keyof typeof statusConfig] ?? statusConfig.PENDING;
  const StatusIcon = cfg.icon as React.ComponentType<any>;
          ...
          left={
            <div className="flex flex-wrap items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-2xl sm:text-3xl font-bold tracking-tight text-white">{referral.leadName}</h2>
            ...
            <CardContent className="space-y-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[15px] text-muted-foreground">{referral.affiliate.email}</p>
                </div>
              </div>
              <Separator />
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  ...
                  <code className="rounded bg-muted px-1.5 py-0.5 text-[15px] font-mono">
                    {referral.affiliate.referralCode}
                  </code>
                </div>
                <div className="flex justify-between">
                  <span className="text-muted-foreground">Partner Group</span>
                  <Badge variant="outline" className="text-[15px]">{referral.affiliate.partnerGroup}</Badge>
                </div>
              </div>
            </CardContent>
          </Card>
