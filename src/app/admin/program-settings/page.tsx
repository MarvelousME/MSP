  ...
  return (
    <div className="space-y-6">
      <AdminPageHeader
        compact
        accent="teal"
        eyebrow="Config.Matrix"
        title="Program Settings"
        subtitle="Configure your affiliate program"
      />
        ...
        <CardContent className="grid gap-6">
          ...
          <div className="grid gap-4 md:grid-cols-3">
            ...
            <div className="grid gap-2">
              ...
              <p className="text-[13px] text-muted-foreground">Number of days to hold commissions for refund protection</p>
            </div>
          </div>
            ...
            <TabsContent value="script" className="space-y-4">
              <div>
                <div className="flex items-center justify-between mb-2">
                  <Label className="text-sm font-medium">1. Add this script before <code className="rounded bg-muted px-1.5 py-0.5 text-[15px]">&lt;/body&gt;</code> on every page</Label>
                  <Button variant="ghost" size="sm" onClick={() => handleCopySnippet('script', `<script src="${appUrl}/scripts/msp-tracker.js" data-api-url="${appUrl}"></script>`)}>
                ...
                <div className="rounded-md bg-muted p-4 font-mono text-sm overflow-x-auto">
                  ...
                  {' '}<span className="text-purple-600">src</span>=<span className="text-green-600">&quot;{appUrl}/scripts/msp-tracker.js&quot;</span><br />
              ...
              <div className="rounded-md border p-4 space-y-3">
                ...
                <ol className="text-sm text-muted-foreground space-y-2 list-decimal list-inside">
                  <li>A visitor arrives on <strong>{settings.websiteUrl || 'your site'}</strong> via a referral link (e.g. <code className="rounded bg-muted px-1 py-0.5 text-[15px]">?ref=CODE</code>)</li>
                  <li>The script automatically detects the <code className="rounded bg-muted px-1 py-0.5 text-[15px]">ref</code> parameter and stores a 30-day cookie</li>
                  <li>When the visitor converts (signup, purchase, etc.), you call <code className="rounded bg-muted px-1 py-0.5 text-[15px]">MSP.trackConversion()</code></li>
            ...
            <TabsContent value="referral" className="space-y-4">
              <div className="rounded-md border p-4 space-y-3">
                ...
                <p className="text-sm text-muted-foreground">
                  Affiliates share links to your website with a <code className="rounded bg-muted px-1 py-0.5 text-[15px]">ref</code> query parameter.
                ...
                <p className="text-[15px] text-muted-foreground">
                  The script also recognizes <code className="rounded bg-muted px-1 py-0.5 text-[15px]">?referral=</code> and <code className="rounded bg-muted px-1 py-0.5 text-[15px]">?affiliate=</code> parameters.
                </p>
              </div>
              ...
              <div className="rounded-md border p-4 space-y-3">
                ...
                <p className="text-sm text-muted-foreground">
                  You can also use the built-in redirect route to send visitors through My Stable Prime first:
                </p>
                <div className="rounded-md bg-muted p-3 font-mono text-sm break-all">
