...
//  Constants
// ────────────────────────────────────────────────
const reportTypes: { value: ReportType; label: string; description: string; icon: any }[] = [
  ...
  return (
    <div className="space-y-6">
      <AdminPageHeader
        ...
        title="Reports"
        subtitle="Generate, schedule, and deliver program reports"
      />
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                ...
                <p className="mt-1 text-[15px] text-muted-foreground">{reportTypes.find((r) => r.value === reportType)?.description}</p>
              </div>
