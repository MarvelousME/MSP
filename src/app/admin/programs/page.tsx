  ...
  return (
    <div className="space-y-6">
      <AdminPageHeader
        ...
        title="Programs"
        subtitle="Manage multiple affiliate programs with different commission structures"
        right={
              ...
              <TableBody>
                {programs.map(p => (
                  <TableRow key={p.id}>
                    <TableCell>
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          ...
                          <p className="text-[15px] text-muted-foreground font-mono">/{p.slug}</p>
                        </div>
                        {p.isDefault && <Badge variant="secondary" className="text-[15px]">Default</Badge>}
                      </div>
                    </TableCell>
                    <TableCell>
                      <div className="flex items-center gap-1">
                        ...
                        <span className="text-[15px] text-muted-foreground">{p.commissionType}</span>
                      </div>
                    </TableCell>
                    <TableCell>
                    ...
                    <TableCell><Badge variant="outline" className="text-[15px]">{p.payoutFrequency}</Badge></TableCell>
                    <TableCell>
                      <Badge variant={p.autoApprove ? 'default' : 'outline'} className="text-[15px]">
