              ...
              <div className="grid gap-2">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-1">
                    <Button variant="ghost" size="sm" className="h-7 text-[15px] gap-1" onClick={() => setShowSourceView(!showSourceView)}>
                ...
                <div className="flex flex-wrap gap-1 mb-1">
                  <span className="text-[15px] text-muted-foreground mr-1 py-1">Insert:</span>
                  {AVAILABLE_VARIABLES.map(v => (
                    <Button
                      key={v.name}
                      variant="outline"
                      size="sm"
                      className="h-6 text-[13px] px-2 font-mono"
          ...
          {previewTemplate && (
            <div className="space-y-4">
              <div className="flex flex-wrap gap-1">
                <span className="text-[15px] text-muted-foreground">Variables:</span>
                {previewTemplate.variables.map(v => (
                  <Badge key={v} variant="outline" className="text-[15px] font-mono">{'{{' + v + '}}'}</Badge>
                ))}
              </div>
